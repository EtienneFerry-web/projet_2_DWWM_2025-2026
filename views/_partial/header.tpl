...
<head>
    ...
    <meta name="csrf-token" content="{$smarty.session.csrf_token|default:''}">
    <link rel="shortcut icon" href="{$smarty.env.BASE_URL}assets/img/iconSite.png" type="image/x-icon">
...
<body>
    ...
    <a href="{$smarty.env.BASE_URL}page/contact"
