...
<head>
	...
	<?php if($strPage ==="index" || $strPage ==="movie" || $strPage ==="actor" || $strPage ==="user"){ ?>
...
<body>
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a href="/projet2/index.php"><img src="/Projet2/img/iconSite.png" alt="icon du site" class="iconHeader"></a>
